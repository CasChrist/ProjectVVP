...
# Где:
# current_step = шаг выполнения рецепта (для каждого пользователя - свой)
...
# Пример словаря базы данных (каждому пользователю соответствует словарь
# с его текущим рецептом и шагом выполнения)
chatids = {
    516 : julie
}